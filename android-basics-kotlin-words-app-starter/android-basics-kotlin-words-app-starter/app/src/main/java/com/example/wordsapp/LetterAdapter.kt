...
class LetterAdapter :
    ...
    /**
     * Provides a reference for the views needed to display items in
    your list.
     */
    class LetterViewHolder(val view: View) :
     ...
     */
    override fun onBindViewHolder(holder: LetterViewHolder, position:
    Int) {
        val item = list.get(position)
        holder.button.text = item.toString()
        // Assigns a [OnClickListener] to the button contained in the [RecyclerView.ViewHolder]
        holder.button.setOnClickListener {
            ...
            intent.putExtra(DetailActivity.LETTER,
    ...
    companion object Accessibility : View.AccessibilityDelegate() {
        ...
        override fun onInitializeAccessibilityNodeInfo(
            ...
            // With `null` as the second argument to [AccessibilityNodeInfo.AccessibilityAction], the
