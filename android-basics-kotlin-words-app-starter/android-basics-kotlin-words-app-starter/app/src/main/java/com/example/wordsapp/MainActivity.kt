...
/**
 * Main Activity and entry point for the app. Displays a RecyclerView
of letters.
 */
class MainActivity : AppCompatActivity() {
    ...
    /**
     * Sets the LayoutManager for the [RecyclerView] based on the
    desired orientation of the list.
     */
...
// The following code is equivalent to
    ...
    /**
     * Determines how to handle interactions with the selected
    [MenuItem]
     */
